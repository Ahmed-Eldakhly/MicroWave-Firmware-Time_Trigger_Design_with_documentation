...
static void Scheduler_Core(void)
{
    ...
    Timer0_write_counter(COUNTER16BITS - u32compare_value);
...
static EnumScheduler_Error_t Scheduler_Tick_time_calculation(TickTime a_u8tickTme)
{
    ...
    else if (u32compare_value / 16 < COUNTER16BITS)
    {
    ...
    else if (u32compare_value / 32 < COUNTER16BITS)
    {
    ...
    else if (u32compare_value / 64 < COUNTER16BITS)
    {
    ...
    else if (u32compare_value / 128 < COUNTER16BITS)
    {
    ...
    else if (u32compare_value / 256 < COUNTER16BITS)
    {
 ...
 *
 * Description: 	Remove Function to Scheduler Queue
 *
 * Inputs:			u8 (Function's ID)
 *
 * Outputs:			NULL
 *
 * Return:			EnumScheduler_Error_t   (typedef for scheduler errors).
